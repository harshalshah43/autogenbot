...
agent1 = AssistantAgent(
    ...
    system_message=(
        ...
        "You must collect following shipping information:- port of loading, port of delivery, pickup address, delivery address and package summary."
        "You can use tools to make port suggestions"
        ...
        "Customer information is mandatory, shipping information is not. Do not generate RFQ id unless customer information is collected."
